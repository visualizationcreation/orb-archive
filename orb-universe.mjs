...
export function mountUniverse({catalog,overview}){
 ...
 const css=document.createElement('link');css.rel='stylesheet';css.href=new URL('./orb-universe.css?v=media-20260919',import.meta.url).href;document.head.append(css);
