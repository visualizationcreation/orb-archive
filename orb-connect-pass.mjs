...
export const pass={version:1,date:'2026-09-19',author:'ORB Connect · authored with Codex',groups:[
 {id:'self-development',title:'Self-Development',es:'Desarrollo personal',color:'#bd9bce',summary:'Small changes, deeper living. Explore action, purpose, beliefs and relationships through original readings, practical exercises and research.',summaryEs:'Pequeños cambios, una vida más profunda. Explora acción, propósito, creencias y relaciones con lecturas, ejercicios e investigación.',members:[['from-intention-to-action','Turn a chosen value into a practical next step.'],['a-life-that-matters','Explore belonging and contributions you can sustain.'],['the-beliefs-we-live-by','Examine assumptions through evidence and small experiments.'],['connection-without-losing-yourself','Practice requests, listening and limits while keeping both people visible.']]},
 ...
 ['self-development','belief-memory','Connect practical reflection with the wider exploration of beliefs and meaning.'],
 ['self-development','ways-seeing','Move from examining an assumption to exploring different ways of interpreting experience.'],
