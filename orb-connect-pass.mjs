...
export const pass={version:1,date:'2026-09-16',author:'ORB Connect · authored with Codex',groups:[
 ...
 [park,'An urban forest brings museums, public space and layered histories together.'],['dia-de-muertos','Explore remembrance and regional traditions on their own terms.'],[rock,'Follow bands, concerts and the changing places of rock in Mexico.'],[food,'The cooking ORB includes Mexican and Yucatecan preparations within a wider Latin American scope.']]},
 ...
 ['the-orb-skill','Learn the method for moving through questions and connected ideas.'],['crystal-ball-orb','Explore forecasts as possibilities to examine, rather than settled outcomes.'],['core-belief','Notice how assumptions shape interpretation.'],['autumn-in-two-orbits','See a familiar season through poems, photographs and listening.']]}
],links:[
